...
"entrer_parents":"👪 Entrer — فضاء الآباء","entrer_pro":"👨‍⚕️ Entrer — فضاء المختصين",
...
# ── AIDE ────────────────────────────────────────────────────────────────
"aide_titre":"❓ المساعدة et Documentation",
...
"orientation":"🧭 التوجيه","conseils":"💡 Practical Tips",
...
# ── NOTIFICATIONS ────────────────────────────────────────────────────────
"notif_titre":"🔔 الإشعارات","notif_vide":"No notifications",
...
"imitation":"التقليد","jeu_symbolique":"Symbolic play",
...
"prevalence":"الانتشار","prise_en_charge":"Coverage",
...
with st.sidebar:
    ...
    if st.session_state.get("auth_connecte", False):
        ...
        plan_colors = {
            "مجاني": "#4CAF50", "عائلي مميز": "#FF6B9D",
            "Professionnel": "#4A90E2", "مؤسسة": "#6C3FC5"
        }
    ...
    with c1:
        if st.button("🌙" if not dark else "☀️", key="theme_btn"):
            ...
            st.rerun()
    with c2:
        st.markdown(f"**{'داكن' if not dark else 'فاتح'}**")
    with c3:
    ...
    if st.session_state.get("show_notif", False):
        ...
        if notifs:
            ...
            st.markdown("<p style='color:#888;font-size:0.85rem;'>لا توجد إشعارات</p>",
                        unsafe_allow_html=True)
    ...
    if espace == 'parent':
        st.markdown("<span class='badge-parent'>👪 فضاء الآباء</span>", unsafe_allow_html=True)
        st.markdown("")
        menu_items = [
        ...
        st.markdown("<span class='badge-pro'>👨‍⚕️ فضاء المختصين</span>", unsafe_allow_html=True)
        st.markdown("")
        menu_items = [
        ...
        menu_items = ["🏠 الرئيسية", "💰 نموذج الأعمال", "📊 إحصائيات الجزائر", "❓ المساعدة"]
...
if mp("accueil") and esp is لاe:
    ...
    <div class='main-header'>
        ...
        <p style='color:white; font-size:1.3rem;'>منصة ذكية لأطفال طيف التوحد</p>
        <p style='color:rgba(255,255,255,0.85);'>بقلم: حجوب ذكرى - ماستر 2 IATI - مناقشة 2026</p>
    </div>
    """, unsafe_allow_html=True)

    st.markdown("## 👋 مرحباً! من أنت؟")
    col1, col2 = st.columns(2)
    with col1:
        st.markdown("""
        <div class='card' style='border-top:4px solid #FF6B9D; text-align:center;'>
            <div style='font-size:4rem;'>👪</div>
            <h2 style='color:#FF6B9D;'>فضاء الآباء</h2>
            <p style='color:#888;'>تابع تطور طفلك.</p>
    ...
    with col2:
        ...
        <div class='card' style='border-top:4px solid #4A90E2; text-align:center;'>
            ...
            <h2 style='color:#4A90E2;'>فضاء المختصين</h2>
    ...
    <div class='card' style='border-top:4px solid #FF6B9D;'>
        ...
        <div style='display:grid; grid-template-columns:1fr 1fr; gap:1rem;'>
            ...
            <div style='background:#F0F8FF;border-radius:10px;padding:1rem;border-left:4px solid #4A90E2;'>
                <h4 style='color:#4A90E2;margin:0 0 0.5rem;'>🧭 التوجيه</h4>
                <p style='color:#555;margin:0;font-size:0.95rem;'>
            ...
            <div style='background:#F0FFF4;border-radius:10px;padding:1rem;border-left:4px solid #4CAF50;'>
                <h4 style='color:#4CAF50;margin:0 0 0.5rem;'>💡 نصائح عملية</h4>
                <p style='color:#555;margin:0;font-size:0.95rem;'>
...
# ============================================================
    ...
    st.markdown(
        ...
        f"<p style='color:white;font-size:1.1rem;'>كيف يمكنني مساعدتك اليوم؟</p>"
        f"</div>",
        unsafe_allow_html=True
    )
    ...
    for col, (icon, title, sub, color, page) in zip([c1, c2, c3], tiles):
        with col:
            ...
            if st.button(f"فتح ←", key=f"tile_{page}", use_container_width=True):
    ...
    actions = [
        ("🧬", "Diagnostic IA", "#50E3C2", "🧬 تشخيص الذكاء الاصطناعي"),
        ("🧭", "Orientation", "#4CAF50", "🧭 التوجيه"),
        ("💡", "Conseils", "#F5A623", "💡 نصائح عملية"),
        ("🔔", "Alertes", "#FF4444", "🔔 التنبيهات"),
    ]
    ...
    with col_p:
        st.markdown(
            ...
            "<div><p style='margin:0;font-weight:700;color:#333;font-size:1.05rem;'>عرض الملف الكامل</p>"
            "<p style='margin:0;color:#888;font-size:0.88rem;'>الدرجات السريرية، العلاجات الجارية، السجل</p></div>"
            "</div>",
            unsafe_allow_html=True
        )
    with col_btn:
...
# ============================================================
    ...
    st.markdown(
        "<div class='main-header'>"
        "<h1 style='color:white;'>🧬 تشخيص الذكاء الاصطناعي Multi-Modal</h1>"
        "<p style='color:white;'>4 تقنيات تحليل تلقائي للكشف عن التوحد</p>"
        "</div>",
        unsafe_allow_html=True
    )
        ...
        with col_upload:
            if uploaded_img is not لاe:
                ...
                if st.button("🧠 Lancer l'analyse faciale IA", use_container_width=True, key="btn_face"):
                    ...
                    col1, col2, col3, col4 = st.columns(4)
                    metriques = [
                        ("👁️ التواصل البصري",     contact_visuel,   col1),
                    ...
                    if contact_visuel < 0.5:
                        observations.append(("🔴", "التواصل البصري reduit detecte", "Signe potentiel TSA a approfondir"))
    ...
    with tab3:
        ...
        with col2:
            st.markdown("""
            #### 🔬 Ce que l'IA analyse
            - **التواصل البصري** : regarde-t-il l'ecran ?
          ...
          <div id="progress-wrap" style="margin-top:1rem;display:none;">
            ...
            <div style="display:flex;gap:1rem;margin-top:0.8rem;flex-wrap:wrap;" id="live-metrics">
              <div style="background:#EEF5FF;border-radius:8px;padding:0.5rem 0.8rem;flex:1;text-align:center;">
                ...
                <div style="font-size:0.75rem;color:#888;">التواصل البصري</div>
              </div>
        ...
        function showReport(regard, social, evitement, fixation) {
          ...
          const riskLabel = risk < 30 ? "منخفض" : risk < 60 ? "متوسط" : "مرتفع";
          ...
          document.getElementById("result-panel").innerHTML = `
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:0.8rem;margin-bottom:1rem;">
              ...
              <div style="background:#FFF0F5;padding:0.8rem;border-radius:8px;text-align:center;">
                ...
                <div style="font-size:0.8rem;color:#888;">معدل التجنب</div>
              </div>
...
# ============================================================
    ...
    st.markdown(
        "<div class='main-header'>"
        "<h1 style='color:white;'>🧬 تشخيص الذكاء الاصطناعي — Version Clinique</h1>"
    ...
    if not df.empty:
        # Selecteur patient
        pid_diag = st.selectbox("👤 اختر مريضًا a evaluer",
        ...
        with tab1:
            ...
            label_mc = "خطر مرتفع" if pct_mchat > 60 else "خطر متوسط" if pct_mchat > 30 else "خطر منخفض"
            st.markdown(
        ...
        with tab3:
            ...
            interv_names_d = {"orthophonie":"علاج النطق","psychomotricite":"العلاج النفسحركي",
                "aba":"ABA","teacch":"TEACCH","pecs":"PECS"}
...
# ============================================================
    ...
    st.markdown(
        "<div class='main-header'><h1 style='color:white;'>🔍 الكشف المبكر عن التوحد</h1>"
        "<p style='color:white;'>استبيان رصد علامات طيف التوحد</p></div>",
        unsafe_allow_html=True
    )
...
# ============================================================
    ...
    st.markdown(
        "<div class='main-header'><h1 style='color:white;'>🧭 التوجيه vers les Specialistes</h1>"
...
# ============================================================
    ...
    st.markdown(
        "<div class='main-header'><h1 style='color:white;'>💡 نصائح عملية في المنزل</h1>"
    ...
    if not df.empty:
        ...
        if sc_imitation >= 5:
            conseils.append(("🎭 التقليد et Jeu", "#F5A623", [
    ...
    if not df.empty:
        ...
        with col2:
            ...
            for label, col_name in [
                ("🗣️ التواصل الاجتماعي",  'communication_sociale'),
                ("🤝 التفاعلات الاجتماعية",   'interactions_sociales'),
                ("👁️ التواصل البصري",           'contact_visuel'),
                ("📚 اللغة التعبيرية",        'langage_expressif'),
                ("🔄 التقليد",                'imitation'),
                ("🎭 اللعب الرمزي",           'jeu_symbolique'),
            ]:
...
# ============================================================
    ...
    st.markdown(
        "<div class='main-header'><h1 style='color:white;'>🔔 التنبيهات Automatiques</h1>"
    ...
    if not df.empty:
        ...
        checks = [
            ('communication_sociale',    7, "urgent",    "🔴 URGENT",    "التواصل الاجتماعي tres limitee",    "Consultez un orthophoniste rapidement.",        "#FF4444"),
            ('communication_sociale',    5, "attention", "🟠 ATTENTION", "التواصل الاجتماعي a surveiller",     "Bilan orthophonique recommande.",               "#FFA500"),
            ('contact_visuel',           7, "urgent",    "🔴 URGENT",    "التواصل البصري tres faible",             "Consultez un specialiste TSA.",                 "#FF4444"),
            ('langage_expressif',        7, "attention", "🟠 ATTENTION", "Retard de langage expressif",            "Therapie PECS ou orthophonie en priorite.",     "#FFA500"),
            ('comportements_restreints', 7, "urgent",    "🔴 URGENT",    "السلوكيات المقيدة severes",       "Therapie ABA recommandee en urgence.",          "#FF4444"),
            ('interactions_sociales',    7, "attention", "🟠 ATTENTION", "التفاعلات الاجتماعية tres limitees",    "Programme d'integration sociale recommande.",   "#FFA500"),
        ]
        seen = set()
        ...
        if 'anxiete' in patient.index and patient['anxiete'] == 1:
            alertes.append(("info", "🟡 INFO", "القلق diagnostiquee", "Suivi psychologique conseille.",              "#FFD700"))
...
# ============================================================
    ...
    st.markdown(
        ...
        f"<p style='color:white;'>Vous avez <b style='font-size:1.3rem;'>{n_patients_pro}</b> مرضى في فضائك الخاص</p>"
        f"</div>",
        unsafe_allow_html=True
    )
    st.markdown(
    ...
    for col, (val, label) in zip([col1, col2, col3, col4], [
        ...
        ("92%",  "Precision IA"),    ("8", "مؤسسةs partenaires"),
    ]):
        with col:
            st.markdown(
                f"<div class='card' style='text-align:center;'>"
    ...
    if not df.empty:
        ...
        with col2:
            ...
            nm     = {'orthophonie':'علاج النطق','psychomotricite':'العلاج النفسحركي',
                      'aba':'ABA','teacch':'TEACCH','pecs':'PECS'}
...
# ============================================================
    ...
    if not df.empty:
        ...
        with col1:
            ...
            st.markdown("### 🏥 الأمراض المصاحبة")
            has_comor = False
            if 'tdah' in patient.index and patient['tdah'] == 1:
                st.warning("🔴 TDAH"); has_comor = True
            if 'anxiete' in patient.index and patient['anxiete'] == 1:
                st.warning("🟠 القلق"); has_comor = True
            if 'trouble_sommeil' in patient.index and patient['trouble_sommeil'] == 1:
        ...
        with col2:
            ...
            score_cols = [
                ...
                ("التفاعلات الاجتماعية",    'interactions_sociales'),
                ("السلوكيات المقيدة", 'comportements_restreints'),
                ("اللغة التعبيرية",        'langage_expressif'),
                ("اللغة الاستقبالية",         'langage_receptif'),
                ("التواصل البصري",           'contact_visuel'),
                ("التقليد",                'imitation'),
                ("اللعب الرمزي",           'jeu_symbolique'),
            ]
            score_vals = []
    ...
    if not df.empty:
        ...
        with col1:
            ...
            for k, v in sorted_v:
                ...
                level = "✅ موصى به بشدة" if pct>=60 else "🟡 Recommande" if pct>=40 else "⬜ اختياري"
                st.markdown(
...
# ============================================================
    ...
    if not df.empty:
        ...
        with col3: st.metric("Taux علاج النطق", f"{(df['orthophonie']==1).mean()*100:.0f}%")
        ...
        with c2: st.metric("القلق",          f"{(df['anxiete']==1).mean()*100:.0f}%")
...
# ============================================================
    ...
    st.markdown(
        "<div class='main-header'><h1 style='color:white;'>💰 نموذج الأعمال</h1>"
...
# ============================================================
    ...
    if not df.empty:
        ...
        with col2:
            ...
            interv_names = {'orthophonie':'علاج النطق','psychomotricite':'العلاج النفسحركي',
                            'aba':'ABA','teacch':'TEACCH','pecs':'PECS'}
            for rank, (_, nb) in enumerate(neighbors.iterrows(), 1):
    ...
    if not df.empty:
        ...
        with col_left:
            ...
            for _, row in df_urgent.iterrows():
                ...
                interv_badge = ("✅ متابعة نشطة" if interv_ok else "❌ بدون متابعة")
                interv_color = "#4CAF50" if interv_ok else "#FF4444"
                comor = []
                if row.get('tdah',0)==1: comor.append("TDAH")
                if row.get('anxiete',0)==1: comor.append("القلق")
...
# ============================================================
    ...
    gaps = [
        ...
        ("التكفل", "20% vs 72%", "52 points de retard", "#FFA500"),
    ...
    fig_heat = go.Figure(go.Heatmap(
        ...
        text=df_mat.values,
        texttemplate="%{text}/5",
        colorbar=dict(title="المستوى (0-5)")
    ))
...
# ============================================================
    ...
    if st.session_state["patient_sauvegarde"]:
        ...
        with col2:
            if st.button(t("voir_profil"), use_container_width=True):
                st.session_state["patient_sauvegarde"] = False
                st.session_state["menu"] = "📋 ملف المريض"
                st.rerun()
        with col3:
        ...
        if p:
            ...
            with col2:
                interv = [n for k,n in [('orthophonie','علاج النطق'),('psychomotricite','العلاج النفسحركي'),
                          ('aba','ABA'),('teacch','TEACCH'),('pecs','PECS')] if p.get(k,False)]
                comor  = [n for k,n in [('tdah','TDAH'),('anxiete','القلق'),('trouble_sommeil','Trouble sommeil')] if p.get(k,False)]
                st.markdown(
        ...
        with st.form("form_nouveau_patient", clear_on_submit=False):
            ...
            scores_def = [
                ("التواصل الاجتماعي",     "communication_sociale",      5),
                ("التفاعلات الاجتماعية",     "interactions_sociales",      5),
                ("السلوكيات المقيدة",  "comportements_restreints",   4),
                ("اللغة التعبيرية",         "langage_expressif",          5),
                ("اللغة الاستقبالية",          "langage_receptif",           5),
                ("التواصل البصري",            "contact_visuel",             5),
                ("التقليد",                 "imitation",                  4),
                ("اللعب الرمزي",            "jeu_symbolique",             4),
            ]
            ...
            st.markdown("---")
            # ---- SECTION 4 : الأمراض المصاحبة ----
            st.markdown("### 🏥 الأمراض المصاحبة")
            col1, col2, col3 = st.columns(3)
            with col1: c_tdah   = st.checkbox("🔴 TDAH")
            with col2: c_anxiete= st.checkbox("🟠 القلق")
    ...
    st.markdown(
        "<div class='main-header'><h1 style='color:white;'>💬 المراسلة Securisee</h1>"
        "<p style='color:white;'>تواصل مباشر الآباء ↔ المختصون</p></div>",
        unsafe_allow_html=True
    )
    ...
    if "messages_chat" not in st.session_state:
        ...
        st.session_state["messages_chat"] = [
            {"id": 1, "expediteur": "pro", "nom": "Dr. Benali Karima", "role": "Orthophoniste",
             ...
             "contenu": "مرحباً, j'ai consulte le profil de votre enfant. Les scores de communication montrent une legere amelioration ce mois-ci. Continuez les exercices de pointage.",
             "heure": "09:14", "date": "Lundi 02 Mars", "lu": True},
            {"id": 2, "expediteur": "parent", "nom": "Famille Hadjoub", "role": "Parent",
             "avatar": "👪", "couleur": "#FF6B9D",
             "contenu": "مرحباً Docteur, merci pour le suivi. On a remarque qu'il commence a pointer du doigt vers les objets qu'il veut. C'est une bonne nouvelle ?",
            ...
            {"id": 4, "expediteur": "pro", "nom": "Dr. Meziane Sofiane", "role": "Psychologue",
             ...
             "contenu": "مرحباً a tous. J'ai programme la prochaine evaluation pour le 15 mars. Pouvez-vous me confirmer votre disponibilite ?",
    ...
    with col_contacts:
        st.markdown(
            ...
            "<h4 style='margin:0 0 1rem;color:#333;'>👥 الفريق العلاجي</h4>",
            unsafe_allow_html=True
        )
    ...
    with col_chat:
        ...
        st.markdown(
            ...
            f"<span style='color:{contact_actif['statut_color'] if contact_actif['statut'] != 'متصل' else '#90FF90'};'>"
...
st.markdown("---")
badge = (
    "<span class='badge-parent'>👪 فضاء الآباء</span>"       if esp == 'parent'
    else "<span class='badge-pro'>👨‍⚕️ فضاء المختصين</span>" if esp == 'pro'
    else ""
)
st.markdown(
